...
FXparams = environment {
		  ...
		  [tooltip: -1 = dry, 1 = wet]",
		                                          -1, -1.0, 1.0, 0.01));
	           width		= vslider("[4]width[tooltip:wide panner, 0=mono 1=normal 2=out of phase]",	1, 0, 2, 0.1):si.smooth(0.999);
           };
...
// todo use de.sdelay(N, it, dt) for smoot LR delay offset?
